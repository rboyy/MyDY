...
.method public constructor <init>(Lj$/util/stream/a;I)V
    ...
    .line 21
    .line 22
    invoke-static {p2, v1}, Lj$/util/stream/y6;->i(II)I
...
# virtual methods
.method public final A(Lj$/util/Spliterator;Lj$/util/stream/l5;)V
    .locals 2
    ...
    .line 18
    invoke-interface {p2, v0, v1}, Lj$/util/stream/l5;->c(J)V
    ...
    .line 23
    .line 24
    invoke-interface {p2}, Lj$/util/stream/l5;->end()V
    ...
    .line 28
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->B(Lj$/util/Spliterator;Lj$/util/stream/l5;)Z
...
.method public final B(Lj$/util/Spliterator;Lj$/util/stream/l5;)Z
    .locals 2
    ...
    .line 14
    .line 15
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->H(Lj$/util/Spliterator;Lj$/util/stream/l5;)Z
...
.method public final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/f2;
    .locals 2
    ...
    .line 6
    .line 7
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/a;->F(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/f2;
    ...
    .line 16
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/a;->J(JLjava/util/function/IntFunction;)Lj$/util/stream/x1;
    ...
    .line 20
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->R(Lj$/util/Spliterator;Lj$/util/stream/l5;)Lj$/util/stream/l5;
...
.method public final D(Lj$/util/stream/e8;)Ljava/lang/Object;
    .locals 1
    ...
    .line 13
    .line 14
    invoke-interface {p1}, Lj$/util/stream/e8;->f()I
    ...
    .line 22
    invoke-interface {p1, p0, v0}, Lj$/util/stream/e8;->b(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    .line 35
    invoke-interface {p1, p0, v0}, Lj$/util/stream/e8;->a(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method public final E(Ljava/util/function/IntFunction;)Lj$/util/stream/f2;
    .locals 3
    ...
    .line 28
    .line 29
    invoke-virtual {v0, v2}, Lj$/util/stream/a;->O(I)Lj$/util/Spliterator;
    ...
    .line 33
    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/a;->K(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/f2;
    ...
    .line 42
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/a;->C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/f2;
...
.method public abstract F(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/f2;
.end method
...
.method public final G(Lj$/util/Spliterator;)J
    ...
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lj$/util/stream/y6;->n(I)Z
...
.method public abstract H(Lj$/util/Spliterator;Lj$/util/stream/l5;)Z
.end method

.method public abstract I()Lj$/util/stream/z6;
.end method

.method public abstract J(JLjava/util/function/IntFunction;)Lj$/util/stream/x1;
.end method

.method public K(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/f2;
    .locals 0
...
.method public L(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 7
    .line 8
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/a;->K(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/f2;
...
.method public abstract N(ILj$/util/stream/l5;)Lj$/util/stream/l5;
.end method
...
.method public final O(I)Lj$/util/Spliterator;
    ...
    .line 32
    .line 33
    invoke-virtual {v3, v4}, Lj$/util/stream/y6;->n(I)Z
    ...
    .line 77
    .line 78
    invoke-static {v4, v0}, Lj$/util/stream/y6;->i(II)I
    ...
    .line 94
    .line 95
    invoke-static {p1, v0}, Lj$/util/stream/y6;->i(II)I
...
.method public final R(Lj$/util/Spliterator;Lj$/util/stream/l5;)Lj$/util/stream/l5;
    .locals 1
    ...
    .line 6
    .line 7
    invoke-virtual {p0, v0}, Lj$/util/stream/a;->S(Lj$/util/stream/l5;)Lj$/util/stream/l5;
    ...
    .line 11
    invoke-virtual {p0, p1, v0}, Lj$/util/stream/a;->A(Lj$/util/Spliterator;Lj$/util/stream/l5;)V
...
.method public final S(Lj$/util/stream/l5;)Lj$/util/stream/l5;
    .locals 1
    ...
    .line 11
    .line 12
    invoke-virtual {p0, v0, p1}, Lj$/util/stream/a;->N(ILj$/util/stream/l5;)Lj$/util/stream/l5;
...
.method public final onClose(Ljava/lang/Runnable;)Lj$/util/stream/g;
    ...
    .line 15
    :cond_0
    new-instance v2, Lj$/util/stream/d8;

    .line 16
    .line 17
    invoke-direct {v2, v1, p1}, Lj$/util/stream/d8;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
