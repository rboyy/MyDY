...
.method public final a()Landroid/graphics/Canvas;
    ...
    .line 1
    iget-object p0, p0, Lwd3;->a:Landroid/graphics/Canvas;
    ...
    .line 7
    .line 8
    invoke-static {p0}, Le91;->c(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lwd3;->a()Landroid/graphics/Canvas;
    ...
    .line 5
    invoke-static {p0, p1}, Lk8;->b(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lk8;->c(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lk8;->d(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1}, Lk8;->e(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    .line 5
    invoke-static {p0, p1}, Lk8;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 5
    invoke-static {p0}, Lm8;->a(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2}, Lm8;->b(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {p0, p1, p2}, Lm8;->c(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lm8;->d(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Lm8;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p5}, Lm8;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Lha;->c(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, Lha;->d(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lha;->e(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 5
    invoke-static {p0, p1}, Lm8;->g(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {p0 .. p9}, Lm8;->h(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 5
    invoke-static {p0}, Lm8;->i(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Ls4;->f(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {p0, p1}, Ls4;->g(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Ls4;->h(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
