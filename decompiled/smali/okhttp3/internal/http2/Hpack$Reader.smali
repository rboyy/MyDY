...
# direct methods
.method public constructor <init>(Lh83;I)V
    .locals 6
...
.method public constructor <init>(Lh83;II)V
    .locals 0
    ...
    .line 19
    .line 20
    invoke-direct {p2, p1}, Ljn2;-><init>(Lh83;)V

    .line 21
    .line 22
    .line 23
    iput-object p2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt;
...
.method public synthetic constructor <init>(Lh83;IIILod0;)V
    .locals 0
    ...
    .line 38
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lh83;II)V
...
.method private final getName(I)Lku;
    .locals 2
    ...
    .line 49
    .line 50
    invoke-static {p1, p0}, Lco0;->k(ILjava/lang/String;)V
...
.method private final readByte()I
    ...
    .line 1
    iget-object p0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lku;
    ...
    .line 5
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lku;
    ...
    .line 10
    .line 11
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lku;Lku;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    .line 7
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lku;)Lku;
    ...
    .line 16
    .line 17
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lku;Lku;)V
...
.method public final readByteString()Lku;
    .locals 4
    ...
    .line 31
    .line 32
    invoke-virtual {v1, p0, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lmt;JLlt;)V
    ...
    .line 36
    .line 37
    invoke-virtual {v0, v1, v2}, Lbt;->j(J)Lku;
    ...
    .line 43
    .line 44
    invoke-interface {p0, v2, v3}, Lmt;->j(J)Lku;
...
.method public final readHeaders()V
    ...
    .line 1
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lmt;

    .line 2
    .line 3
    invoke-interface {v0}, Lmt;->p()Z
    ...
    .line 92
    .line 93
    invoke-static {p0, v0}, Lco0;->k(ILjava/lang/String;)V
