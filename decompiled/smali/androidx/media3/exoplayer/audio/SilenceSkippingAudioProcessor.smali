...
.method private calculateFadeInPercentage(II)I
    ...
    .line 1
    iget p0, p0, Landroidx/media3/exoplayer/audio/SilenceSkippingAudioProcessor;->minVolumeToKeepPercentageWhenMuting:I
...
.method private isNoise(BB)Z
    ...
    .line 9
    iget-short p0, p0, Landroidx/media3/exoplayer/audio/SilenceSkippingAudioProcessor;->silenceThresholdLevel:S
...
.method private outputRange([BII)V
    ...
    .line 12
    .line 13
    invoke-static {p2, v2, v0}, Lr22;->z(ILjava/lang/String;Z)V
...
.method private outputSilence(II)V
    ...
    .line 106
    .line 107
    invoke-static {p1, v3, v0}, Lr22;->z(ILjava/lang/String;Z)V
