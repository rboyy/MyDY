...
.method public constructor <init>(Landroid/content/Context;Landroidx/media3/exoplayer/offline/WritableDownloadIndex;Landroidx/media3/exoplayer/offline/DownloaderFactory;)V
    ...
    .line 19
    iput-boolean v1, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->downloadsPaused:Z
    ...
    .line 29
    .line 30
    iput-object v2, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->listeners:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    .line 35
    invoke-direct {v2, v3, p0}, Lw50;-><init>(ILjava/lang/Object;)V

    .line 36
    .line 37
    .line 38
    invoke-static {v2}, Landroidx/media3/common/util/Util;->createHandlerForCurrentOrMainLooper(Landroid/os/Handler$Callback;)Landroid/os/Handler;
    ...
    .line 42
    iput-object v8, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->applicationHandler:Landroid/os/Handler;
    ...
    .line 53
    .line 54
    new-instance v4, Landroidx/media3/exoplayer/offline/DownloadManager$InternalHandler;

    .line 55
    .line 56
    iget v9, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->maxParallelDownloads:I

    .line 57
    .line 58
    iget v10, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->minRetryCount:I

    .line 59
    .line 60
    iget-boolean v11, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->downloadsPaused:Z
    ...
    .line 64
    invoke-direct/range {v4 .. v11}, Landroidx/media3/exoplayer/offline/DownloadManager$InternalHandler;-><init>(Landroid/os/HandlerThread;Landroidx/media3/exoplayer/offline/WritableDownloadIndex;Landroidx/media3/exoplayer/offline/DownloaderFactory;Landroid/os/Handler;IIZ)V

    .line 65
    .line 66
    .line 67
    iput-object v4, p0, Landroidx/media3/exoplayer/offline/DownloadManager;->internalHandler:Landroidx/media3/exoplayer/offline/DownloadManager$InternalHandler;
    ...
    .line 70
    .line 71
    invoke-direct {p2, v0, p0}, Lin;-><init>(ILjava/lang/Object;)V
    ...
    .line 77
    .line 78
    sget-object v0, Landroidx/media3/exoplayer/offline/DownloadManager;->DEFAULT_REQUIREMENTS:Landroidx/media3/exoplayer/scheduler/Requirements;

    .line 79
    .line 80
    invoke-direct {p3, p1, p2, v0}, Landroidx/media3/exoplayer/scheduler/RequirementsWatcher;-><init>(Landroid/content/Context;Landroidx/media3/exoplayer/scheduler/RequirementsWatcher$Listener;Landroidx/media3/exoplayer/scheduler/Requirements;)V
    ...
    .line 94
    invoke-virtual {v4, v1, p1, p0}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
